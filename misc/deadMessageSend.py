...
from lib.Common import TestResult, UnitInstanceInfo, Message, MessageType
from threading import Thread


HEALTH_CENTRAL_QUEUE_IP='localhost'
USERNAME=''
PASSWORD=''
SYSTEM_NAME=''
UNIT_ID=''
...
if __name__ == '__main__':
    ...
    unitDetails = UnitInstanceInfo(id=args[2], uuid=args[1], type=args[3], system=SYSTEM_NAME, username=USERNAME, password=PASSWORD)
    ...
    print("Sending I am alive message " + stringMessage)
    print str(unitDetails)

    executor = TestExecutor(HEALTH_CENTRAL_QUEUE_IP, SYSTEM_NAME, UNIT_ID, binding_keys, credentials, queueName, unitDetails)

    executor.sendMessage(HEALTH_CENTRAL_QUEUE_IP, SYSTEM_NAME, SYSTEM_NAME, SYSTEM_NAME+ ".lifecycle.dead", credentials, "dead", stringMessage)

    #python ./ondemanddead.py 10.99.0.82-Tomcat-StreamingAnalytics Service.StreamingAnalytics Service
